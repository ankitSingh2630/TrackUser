...
async function getUserData(apiUrl) {
  try {
    ...
    console.log('Data retrieved successfully:', data); // Output the response
    return data; // Return the data for further use
  } catch (error) {
    console.error('Error fetching data from server:', error); // Handle errors
    throw error; // Re-throw error if needed for higher-level handling
  }
}

// Usage example
const apiUrl = 'https://urlpt.technians.in/userdata/';

getUserData(apiUrl)
  .then((data) => {
    console.log('Processed Data:', data); // Process the data further
  })
  .catch((error) => {
